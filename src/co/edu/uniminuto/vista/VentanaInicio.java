...
import co.edu.uniminuto.clases.Validacion;
...
public class VentanaInicio extends JFrame implements ActionListener {
    ...
    private void construirVentana() {
        ...
        this.setTitle("Automatas Version 1.0");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnValidar) {
            ...
            File archivo = abrirVentana();
            try {
                CargarDatos c = new CargarDatos(grafo, archivo);
                c.cargarMatriz();
                armarGrafo(grafo);
                panelMedio.setGrafo(grafo);
                panelMedio.update(panelMedio.getGraphics());
    ...
    private JPanel panelDatos() {
        ...
        btnValidar.setPreferredSize(new Dimension(50, (panelInferior.getHeight() * 25) / 100));
        btnValidar.addActionListener(this);
        panelDatos.add(btnValidar);
        btnCargar = new JButton("Cargar De Archivo");
        btnCargar.setSize(new Dimension(50, (panelInferior.getHeight() * 25) / 100));
        btnCargar.addActionListener(this);
        panelDatos.add(btnCargar);
        return panelDatos;
    }
    ...
    private void panelCargaDatos() {
        ...
        btnGrabarNodo = new JButton("Grabar");
        ...
        panelCargaDatos.add(new JLabel(""));
        panelCargaDatos.add(new JLabel("Grabar Transicion"));
        panelCargaDatos.add(new JLabel(""));
